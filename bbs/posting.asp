          ...
          <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td> <form action="submitpost.asp" method="post" name="post" onsubmit="return checkForm(this)">
                          <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000">
                            <tr> 
                              <td height="30" colspan="2" class="book_tdtop3"><div align="center" class="white12150">发表新贴子</div></td>
                            </tr>
                            <tr> 
            ...
            style="WIDTH: 450px" tabIndex=2 > </td>
                            </tr>
                            <tr> 
