      ...
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> <form action="SubmitUpdate.asp?id=<%=id%>" method="post" name="post" onsubmit="return checkForm(this)">
                    <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000">
                      <tr> 
                        <td height="30" colspan="2" class="book_tdtop3"><div align="center" class="white12150">编辑贴子</div></td>
                      </tr>
                      <tr> 
                        <td width="200" height="30"><div class="black12150"><strong>主题：</strong></div></td>
                        <td height="30"> <input name="subject" type="text" size="45" maxlength="60" class=post 
            style="WIDTH: 450px" tabIndex=2 value="<%=.fields("bbsTitle")%>"> 
                        </td>
                      </tr>
                      <tr> 
                        ...
                        title=眨眼 alt=眨眼 src="../../bbs/bbsface/mellow.gif" 
                        border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':huh:')"><IMG 
                        title=喔佩服 alt=喔佩服 src="../../bbs/bbsface/huh.gif" 
                        border=0></A></TD>
                                        <TD><A href="javascript:emoticon('^_^')"><IMG title=可爱 
                        alt=可爱 src="../../bbs/bbsface/happy.gif" border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':o')"><IMG title=噢我的上帝 
                        alt=噢我的上帝 src="../../bbs/bbsface/ohmy.gif" 
                      border=0></A></TD>
                                      </TR>
                                      <TR vAlign=center align=middle> 
                                        <TD><A href="javascript:emoticon(';)')"><IMG title=抛眉眼 
                        alt=抛眉眼 src="../../bbs/bbsface/wink.gif" border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':P')"><IMG title=吐舌头 
                        alt=吐舌头 src="../../bbs/bbsface/tongue.gif" 
                      border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':D')"><IMG title=大笑 
                        alt=大笑 src="../../bbs/bbsface/biggrin.gif" 
                      border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':lol:')"><IMG title=笑 
                        alt=笑 src="../../bbs/bbsface/laugh.gif" 
                    border=0></A></TD>
                                      </TR>
                                      <TR vAlign=center align=middle> 
                                        <TD><A href="javascript:emoticon('B)')"><IMG title=酷 
                        alt=酷 src="../../bbs/bbsface/cool.gif" border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':rolleyes:')"><IMG 
                        title=转眼睛 alt=转眼睛 src="../../bbs/bbsface/rolleyes.gif" 
                        border=0></A></TD>
                                        <TD><A href="javascript:emoticon('-_-')"><IMG title=困了 
                        alt=困了 src="../../bbs/bbsface/sleep.gif" border=0></A></TD>
                                        <TD><A href="javascript:emoticon('<_<')"><IMG title=斜眼看 
                        alt=斜眼看 src="../../bbs/bbsface/dry.gif" 
                    border=0></A></TD>
                                      </TR>
                                      <TR vAlign=center align=middle> 
                                        <TD><A href="javascript:emoticon(':)')"><IMG title=微笑 
                        alt=微笑 src="../../bbs/bbsface/smile.gif" border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':wub:')"><IMG 
                        title=暗送秋波 alt=暗送秋波 src="../../bbs/bbsface/wub.gif" 
                        border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':angry:')"><IMG 
                        title=生气 alt=生气 src="../../bbs/bbsface/mad.gif" 
                        border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':(')"><IMG title=不高兴 
                        alt=不高兴 src="../../bbs/bbsface/sad.gif" 
                    border=0></A></TD>
                                      </TR>
                                      <TR vAlign=center align=middle> 
                                        <TD><A href="javascript:emoticon(':unsure:')"><IMG 
                        title=是真的吗 alt=是真的吗 src="../../bbs/bbsface/unsure.gif" 
                        border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':wacko:')"><IMG 
                        title=不象话 alt=不象话 src="../../bbs/bbsface/wacko.gif" 
                        border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':blink:')"><IMG 
                        title=眨眼 alt=眨眼 src="../../bbs/bbsface/blink.gif" 
                        border=0></A></TD>
                                        <TD><A href="javascript:emoticon(':h34r:')"><IMG 
                        title=武士 alt=武士 src="../../bbs/bbsface/ph34r.gif" 
                        border=0></A></TD>
                                      </TR>
                                    </TBODY>
                                  </TABLE></TD>
                  ...
                  value="提示: 文字风格可以快速使用在选择的文字上" name=helpbox>
                              ...
                              <TR> 
                                <TD colSpan=9><SPAN class=black12150> 
                                  <TEXTAREA  onkeyup=storeCaret(this); style="WIDTH: 450px" onclick=storeCaret(this); tabIndex=3 name=message rows=15 wrap=virtual cols=35 onselect=storeCaret(this);><%=.fields("bbsContent")%></TEXTAREA>
                                  </SPAN></TD>
                              </TR>
                            </TBODY>
                          </TABLE></td>
                      ...
                      <tr> 
                        <td width="200" height="30"><div class="black12150"><strong>帖子类型：</strong></div></td>
                        <td height="30"> <select name="status" >
                            <%
							  select case .fields("status")
							  case 1
							  	response.write "<option selected value=""1"">公告</option><option value=""2"">置顶</option><option value=""3"">帖子</option>"
							  case 2
							  	response.write "<option value=""1"">公告</option><option value=""2"" selected>置顶</option><option value=""3"">帖子</option>"
							  case 3
							  	response.write "<option value=""1"">公告</option><option value=""2"">置顶</option><option selected value=""3"">帖子</option>"
							  end select
							  %>
                          </select> </td>
                      </tr>
