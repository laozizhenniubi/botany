...
strSql="select question from questiononline where questionid='" & id & "'"
      ...
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> <form action="submitanswer.asp?id=<%=id%>" method="post" name="post">
                    <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000">
                      ...
                      <tr> 
                        ...
                        <td height="30" valign="top"><TEXTAREA name=question cols=45 rows=15 style="WIDTH: 450px" class="post" tabIndex=2><%=.fields("question")%></TEXTAREA>
                        </td>
                      </tr>
                      <tr> 
                            ...
                            <TBODY>
                              <TR> 
                                <TD><SPAN class=black12150> 
                                  <TEXTAREA name=answer cols=35 rows=22 wrap=virtual id="answer" style="WIDTH: 450px" tabIndex=3></TEXTAREA>
                                  </SPAN></TD>
                              </TR>
                            </TBODY>
                          </TABLE></td>
                      ...
                      <tr> 
                        <td height="30" colspan="2"><div align="center" class="black12150"> 
                            <input type="submit" name="Submit" value="提  交  内  容">
                          </div></td>
                      </tr>
                    </table>
                  </form></td>
